    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        .reset-root { min-height: 100vh; background-color: #111214; display: flex; align-items: center; justify-content: center; font-family: 'Inter', sans-serif; padding: 2rem; }
        .reset-card { width: 100%; max-width: 400px; animation: fadeUp 1s cubic-bezier(0.16, 1, 0.3, 1) both; }
        ...
        .reset-title { font-family: 'IM Fell English', serif; font-style: italic; font-weight: 400; font-size: 1.1rem; color: #6a6f7a; text-align: center; margin-bottom: 2.4rem; letter-spacing: 0.06em; }
        ...
        .done-msg { font-family: 'IM Fell English', serif; font-style: italic; font-weight: 400; font-size: 1.05rem; color: #6a6f7a; text-align: center; letter-spacing: 0.06em; line-height: 1.9; padding: 1rem 0 2rem; animation: fadeUp 0.6s ease both; }
        .reset-btn { width: 100%; margin-top: 2rem; padding: 0.9rem; background: transparent; border: 1px solid #2a2d34; color: #6a6f7a; font-family: 'Inter', sans-serif; font-size: 0.6rem; font-weight: 300; letter-spacing: 0.3em; text-transform: lowercase; cursor: pointer; transition: all 0.4s ease; }
        .reset-btn:hover { border-color: #6a6f7a; color: #b0b5c0; }
